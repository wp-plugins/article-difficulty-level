...
# placing our meta box in three locations namely attachment, post and page.
    ...
    foreach ($buffercode_location as $buffercode_locations) {
         ...
         */
        add_meta_box(
                'buffercode_post_mode_id', __('Post Strength Mode', 'buffercode_box'), 'buffercode_inner_post_mode', $buffercode_locations
        );
    }
}
...
// Getting star
        $star_value = get_option('bc_star');
        if ($bc_star_size_value == 'H1' || $bc_star_size_value == 'H2' || $bc_star_size_value == 'H3' || $bc_star_size_value == 'H4' || $bc_star_size_value == 'H5')
            $bc_star_size_value = 'div class="' . $bc_star_size_value . '"';
...
//setting default start size to H2
        if ($bc_star_size_value == "") {
            $bc_star_size_value = 'div class="H2"';
        }

        if (!empty($star_value)) {
            $star = '<i class="fa ' . $star_value . '"></i>';
        } else {
...
// Default values Ends
        ...
        switch ($meta_value) { //checking for the value selected
            case 1: //if value 1 selected the one star will be displayed
                ...
                $new_content = '<b>' . $bc_text_field_value . ' </b> &nbsp;&nbsp;&nbsp;<font color=' . $bc_star_color_value . '><' . $bc_star_size_value . ' >' . $star . '</div></font>';

                break;
            case 2: //if value 2 selected the Two star will be displayed

                $new_content = '<b>' . $bc_text_field_value . ' </b>&nbsp;&nbsp;&nbsp;<font color=' . $bc_star_color_value . '><' . $bc_star_size_value . ' >' . $star . ' ' . $star . '</div></font>';
                break;
            case 3: //if value 3 selected the Three star will be displayed

                $new_content = '<b>' . $bc_text_field_value . ' </b>&nbsp;&nbsp;&nbsp;<font color=' . $bc_star_color_value . '><' . $bc_star_size_value . ' >' . $star . ' ' . $star . ' ' . $star . '</div></font>';
                break;
            case 4: //if value 4 selected the four star will be displayed
                $new_content = '<b>' . $bc_text_field_value . ' </b>&nbsp;&nbsp;&nbsp;<font color=' . $bc_star_color_value . '><' . $bc_star_size_value . ' >' . $star . ' ' . $star . ' ' . $star . ' ' . $star . '</div></font>';
                break;
            case 5: //if value 5 selected the five star will be displayed

                $new_content = '<b>' . $bc_text_field_value . ' </b>&nbsp;&nbsp;&nbsp;<font color=' . $bc_star_color_value . '><' . $bc_star_size_value . ' >' . $star . ' ' . $star . ' ' . $star . ' ' . $star . ' ' . $star . '</div></font>';
...
function article_bc_columns_content($column_name, $post_id) {
    if ($column_name == 'meta_value_col') {
        ...
        switch ($meta_value_star) {
            case 1:
                echo '<h2 style=\'display:inline-block;margin:-10px 0px 0px 0px;\'>' . $star . '</h2>';
                break;
            case 2:
                echo '<h2 style=\'display:inline-block;margin:-10px 0px 0px 0px;\'>' . $star . ' ' . $star . '</h2>';
                break;
            case 3:
                echo '<h2 style=\'display:inline-block;margin:-10px 0px 0px 0px;\'>' . $star . ' ' . $star . ' ' . $star . '</h2>';
                break;
            case 4:
                echo '<h2 style=\'display:inline-block;margin:-10px 0px 0px 0px;\'>' . $star . ' ' . $star . ' ' . $star . ' ' . $star . '</h2>';
                break;
            case 5:
                echo '<h2 style=\'display:inline-block;margin:-10px 0px 0px 0px;\'>' . $star . ' ' . $star . ' ' . $star . ' ' . $star . ' ' . $star . '</h2>';
                break;
            default:
                echo 'Not Rated';
        }
