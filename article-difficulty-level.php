...
// Default values Ends
		...
		case 1: //if value 1 selected the one star will be displayed
			...
			$new_content = '<!-- Buffercode.com Article Difficulty Level --><b>'.$bc_text_field_value." </b> &nbsp;&nbsp;&nbsp;<font color=".$bc_star_color_value."><".$bc_star_size_value." >&#9734;</div></font><!-- Buffercode.com Article Difficulty Level -->";
		...
		case 4: //if value 4 selected the four star will be displayed
			$new_content = '<!-- Buffercode.com Article Difficulty Level --><b>'.$bc_text_field_value." </b>&nbsp;&nbsp;&nbsp;<font color=".$bc_star_color_value."><".$bc_star_size_value." style=\"display:inline-block; margin:-20px 0px 20px 0px;\">&#9734; &#9734; &#9734; &#9734;</div></font><!-- Buffercode.com Article Difficulty Level -->";
			break;
