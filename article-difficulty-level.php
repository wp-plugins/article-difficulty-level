...
//seeting default star color to black
...
$bc_star_color_value='#000';
		...
		case 1: //if value 1 selected the one star will be displayed
			...
			$new_content .= $bc_text_field_value."&nbsp;&nbsp;&nbsp;<font color=".$bc_star_color_value."><h2 style=\"display:inline-block;margin:-20px 0px 20px 0px;\">&#9734;</h2></font>";
